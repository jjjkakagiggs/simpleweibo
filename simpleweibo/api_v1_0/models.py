...
from  simpleweibo.models import User,Post,Comment
from simpleweibo.extensions import db
from simpleweibo.api_v1_0.errors import Error
from simpleweibo.api_v1_0.authentication import auth
from simpleweibo.api_v1_0 import api
...
class UserByIdApi(Resource):
    ...
    def get(self,id):
        ...
        return jsonify(user.to_json([post.body for post in posts])) # to_json是user类方法
